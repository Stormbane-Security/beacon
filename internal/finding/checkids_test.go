...
func TestDeepChecksHaveCorrectMode(t *testing.T) {
	knownDeep := map[finding.CheckID]bool{
		...
		// === New CVEs (2023-2025 CISA KEV batch) ===
		finding.CheckCVEWPMiniOrangeSocialLogin:      true,
		finding.CheckCVEWPEmailSubscribersSQLi:        true,
		finding.CheckCVEWPPostSMTPBypass:              true,
		finding.CheckCVEWPAutomatic:                   true,
		finding.CheckCVEWooCommercePayments:           true,
		finding.CheckCVEElementorProRCE:               true,
		finding.CheckCVEGlibcIconvOverflow:            true,
		finding.CheckCVEWinRARRecoveryRCE:             true,
		finding.CheckCVESharePointRCE2023:             true,
		finding.CheckCVEOutlookRCE2024:                true,
		finding.CheckCVEContainerdRuncEscape:          true,
		finding.CheckCVEHTTP2RapidReset:               true,
		finding.CheckCVEXZUtilsBackdoor:               true,
		finding.CheckCVECurlSOCKS5Overflow:            true,
		finding.CheckCVECUPSRCE:                       true,
		finding.CheckCVEJumpServerAuthBypass:           true,
		finding.CheckCVETelesquareFirmwareRCE:          true,
		finding.CheckCVEOfficeHTMLRCE:                  true,
		finding.CheckCVEAiohttpPathTraversal:           true,
		finding.CheckCVEDLinkNASCmdInjection:           true,
		finding.CheckCVEApacheHTTPSmuggling:             true,
		finding.CheckCVEApacheH2DoS:                    true,
		finding.CheckCVEOFBizAuthBypass:                true,
		finding.CheckCVEOFBizPreAuthRCE:                true,
		finding.CheckCVEOFBizForceBrowsing:             true,
		finding.CheckCVEPANOSMgmtAuthBypass:            true,
		finding.CheckCVEPANOSPrivEsc:                   true,
		finding.CheckCVEConfluenceTemplateRCE:           true,
		finding.CheckCVEColdFusionFileRead:              true,
		finding.CheckCVEColdFusionDeserial:              true,
		...
		finding.CheckCVEVMwareUHCIUAF:                    true,
		finding.CheckCVESharePointDeserial:                true,
		finding.CheckCVEQlikSenseTunneling:                true,
		finding.CheckCVECiscoNXOSCLI:                     true,
		finding.CheckCVECiscoASADoS:                      true,
		finding.CheckCVECiscoASAPersistImplant:            true,
		finding.CheckCVEProgressLoadMaster:                true,
		finding.CheckCVECleoHarmonyUpload:                 true,
		finding.CheckCVECleoHarmonyExec:                   true,
		finding.CheckCVEIvantiEPMMAuthBypass:              true,
		finding.CheckCVEIvantiEPMMPathTraversal:           true,
		finding.CheckCVEIvantiCSSSRF:                      true,
		finding.CheckCVEGitCloneRCE:                       true,
		finding.CheckCVEDLinkNASRCE:                       true,
		finding.CheckCVESystemdLessTraversal:               true,
		finding.CheckCVETelerikReportServerRCE:              true,
		finding.CheckCVEPyArrowDeserial:                     true,
		finding.CheckCVEMLflowRCE:                           true,
		finding.CheckCVEGradioPathTraversal:                  true,
		finding.CheckCVEJs2pySandboxEscape:                   true,
		// Web framework / CMS CVEs
		finding.CheckCVERailsRenderRCE:           true,
		finding.CheckPortDjangoDefaultCreds:      true,
		finding.CheckCVEJoomlaInfoDisclosure:     true,
		finding.CheckCVEWPHostHeaderReset:        true,
		finding.CheckCVEDjangoJSONFieldSQLi:      true,
		finding.CheckCVERailsFileReadAccept:      true,
		finding.CheckCVEDjangoOrderBySQLi:        true,
		finding.CheckCVEWebminPasswordResetRCE:   true,
		finding.CheckCVEJBossDeserializationRCE:  true,
		...
		finding.CheckCVEFastAPIMultipartReDoS:    true,
		finding.CheckCVEWPCropImageRCE:           true,
		finding.CheckCVELaravelIgnitionRCE:       true,
		finding.CheckCVELaravelAppKeyRCE:         true,
		finding.CheckCVEWebminPackageUpdatesRCE:  true,
		finding.CheckCVEZabbixSAMLAuthBypass:     true,
		finding.CheckCVEPhpMyAdminLFI:            true,
		// Database / infra / middleware CVEs
		finding.CheckCVENeo4jJavaDeserial:        true,
		finding.CheckCVENeo4jAPOCRCE:             true,
		finding.CheckCVECassandraUDFEscape:       true,
		finding.CheckCVEInfluxDBAuthBypass:        true,
		finding.CheckCVEClickHouseRBACBypass:     true,
		finding.CheckCVEKubeletWindowsRCE:        true,
		finding.CheckCVEProxmoxAuthBypass:        true,
		finding.CheckCVEMikroTikWinboxRead:       true,
		finding.CheckCVEMikroTikIPv6RCE:          true,
		finding.CheckCVENacosAuthBypass:          true,
		finding.CheckCVENacosJWTHardcoded:        true,
		finding.CheckCVEHazelcastSessionFixation: true,
		finding.CheckCVENiFiH2RCE:               true,
		// === CVE chains batch (25 playbooks) ===
		finding.CheckCVEKafkaJNDIInjection:        true,
		finding.CheckCVEMosquittoCrash:            true,
		finding.CheckCVEBindGSSTSIGOverflow:       true,
		finding.CheckCVEGhostFileRead:             true,
		finding.CheckCVELocalAIUnauthModel:        true,
		finding.CheckCVEKafkaConfigTraversal:      true,
		finding.CheckCVEZooKeeperSASLBypass:       true,
		finding.CheckCVEComfyUIPathTraversal:      true,
		finding.CheckCVEK8sDashboardSkipAuth:      true,
		finding.CheckCVEGhostMembershipBypass:     true,
		finding.CheckCVEEximUseAfterFree:          true,
		finding.CheckCVEVLLMUnauthInference:       true,
		finding.CheckCVECiscoSNMPRCE:              true,
		finding.CheckCVEPulseVPNAuthBypassRCE:     true,
		finding.CheckCVEExpressOpenRedirect:        true,
		finding.CheckCVEMariaDBLDAPAuthBypass:      true,
		finding.CheckCVERDPBlueKeep:                true,
		finding.CheckCVEOpenSSHTerrapin:            true,
		finding.CheckCVEMosquittoAuthBypass:        true,
		finding.CheckCVEZooKeeperGetACLBypass:      true,
		finding.CheckCVEExpressQSProtoPollution:    true,
		finding.CheckCVEVNCTightVNCInfoLeak:        true,
		finding.CheckCVESupersetAuthBypass:          true,
		finding.CheckCVELog4ShellBypass:             true,
		finding.CheckCVESigRedDNSRCE:                true,
		finding.CheckCVERDPDejaBlue:                  true,
		finding.CheckCVEVNCRealVNCAuthBypass:          true,
		finding.CheckCVENetSNMPAgentXDoS:              true,
		...
		// KEV CVE exploit chains batch
		finding.CheckCVEShellShock:                            true,
		finding.CheckCVELog4j1xTCPDeser:                      true,
		finding.CheckCVEStruts2S2048:                          true,
		finding.CheckCVEStruts2S2053:                          true,
		finding.CheckCVEStruts2S2061:                          true,
		finding.CheckCVEStruts2S2062:                          true,
		finding.CheckCVESparkRESTAuthBypass:                   true,
		finding.CheckCVEOFBizXMLRPCDeser2021:                 true,
		finding.CheckCVESpringCloudGatewaySpEL:               true,
		finding.CheckCVEAPISIXBatchRequests:                   true,
		finding.CheckCVEOFBizDirTraversal2024:                true,
		finding.CheckCVEOFBizScreenWidgetRCE:                 true,
		finding.CheckCVEWPRevSliderUpload:                    true,
		finding.CheckCVEWP3DPrintUpload:                      true,
		finding.CheckCVEWebSphereSoapDeser:                   true,
		finding.CheckCVEWebLogicT3Deser:                      true,
		finding.CheckCVEWebLogicT3JRMP:                       true,
		finding.CheckCVEJenkinsCLIHTTPDeser:                  true,
		finding.CheckCVEJenkinsCLIJavaDeser:                  true,
		finding.CheckCVEJoomlaSQLi2017:                       true,
		finding.CheckCVEConfluenceWidgetTraversal:            true,
		finding.CheckCVETomcatJMXRCE:                         true,
		finding.CheckCVEGitLabProjectImportRCE:               true,
		finding.CheckCVECitrixXenMobileTraversal:             true,
		finding.CheckCVEDrupalgeddon3:                         true,
		finding.CheckCVEExchangeViewStateRCE:                  true,
		...
		// New CVE exploit playbook entries (2026-04-10)
		finding.CheckCVEWPLiteSpeedPrivEsc:       true,
		finding.CheckCVEWPReallySimpleSecBypass:  true,
		finding.CheckCVEWPHunkCompanionInstall:   true,
		finding.CheckCVEWPBackupMigrationRCE:     true,
		finding.CheckCVEWPUltimateMemberSQLi:     true,
		finding.CheckCVEWPQueryConsoleRCE:        true,
		finding.CheckCVEWPForminatorUpload:       true,
		finding.CheckCVEWPElementorFileUploadRCE: true,
		finding.CheckCVEWPTimeCapsuleRCE:         true,
		finding.CheckCVEWPGiveWPInjection:        true,
		finding.CheckCVEConfluencePreAuthFileRead: true,
		finding.CheckCVEJiraSSTIContactAdmin:     true,
		finding.CheckCVEColdFusionWDDXDeserRCE:   true,
		finding.CheckCVEColdFusionDeserUntrusted: true,
		finding.CheckCVEColdFusionWDDXGadgets:    true,
		finding.CheckCVEColdFusionDirTraversal:   true,
		finding.CheckCVECiscoIOSClusterRCE:       true,
		finding.CheckCVECiscoVPNRouterUpload:     true,
		finding.CheckCVEFortiWLMCmdInj:           true,
		finding.CheckCVEFortiOSFormatStringRCE:   true,
		finding.CheckCVEVMwareVRealizeRCE:        true,
		finding.CheckCVEAirflowExperimentalAPI:   true,
